...
def getMax(state,closed,depth):
    """
    Returns the maximum value for the utility.
...
class PacmanAgent(Agent):
    ...
    def get_action(self, state):
        ...
        """
        self.move = self.hminimax1(state)
